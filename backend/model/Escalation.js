...
const EscalationSchema = new mongoose.Schema({
  ...
  toUser: { type: String, required: true }, // User or entity the Escalation is for
  ...
  updatedAt: { type: Date, default: Date.now }, // Timestamp when the Escalation was last updated
});
